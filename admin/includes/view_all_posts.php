...
if (escape(isset($_POST['checkBoxArray']))) {
    ...
    foreach ($_POST['checkBoxArray'] as $postValueId) {
        ...
        , post_status ) ";
                    ...
                    $query .= "VALUES( '{$post_category_id}' , '{$post_title}' , '{$post_author}' , '{$post_user}' ,'{$post_date}' , '{$post_image}' , '{$post_content}' ,
