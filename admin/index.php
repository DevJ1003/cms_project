...
$unnaproved_comment_query = mysqli_query($connection , $query);
$unnaproved_comment_count = mysqli_num_rows($unnaproved_comment_query);
...
?>
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
            ...
            $element_text = ['All Posts' , 'Active Posts' , 'Draft Posts' , 'Comments' , 'Unnaproved Comments' , 'Users' , 'Subscribers' ,
                             'Categories'];

            $element_count = [ $post_count , $post_published_count , $draft_post_count ,  $comment_count , $unnaproved_comment_count , $user_count ,
